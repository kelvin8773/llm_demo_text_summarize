# main_enhanced_ui.py - Enhanced UI LLM Text Summarization Tool
...
<div class="fade-in-up">
    ...
    ">
        ...
        <p style="font-size: 1.2rem; margin: 1rem 0 0 0; opacity: 0.9;">
            Transform lengthy documents into concise summaries with intelligent keyword extraction
        </p>
    </div>
</div>
""", unsafe_allow_html=True)
...
with st.sidebar:
    ...
    if language == "Chinese":
        ...
        st.info("Chinese mode uses specialized Chinese language models for optimal results")
    else:
    ...
    if mode == "Fast Summarizer":
        ...
        model = st.selectbox(
            ...
            help="Select the underlying language model for processing",
            key="model_select"
        )
    else:
        model = None
    ...
    # Summary length with enhanced slider
...
# Main processing section with enhanced styling
if use_sample:
    st.markdown("""
    <div class="fade-in-up">
        <h2 style="color: #667eea; margin-top: 2rem;">
...
if 'raw_text' in locals() and 'summary' in locals():
    ...
    with tab1:
        st.markdown("""
        <div class="fade-in-up">
            <h2 style="color: #667eea;">📄 Generated Summary</h2>
        </div>
        """, unsafe_allow_html=True)
    ...
    with tab2:
        st.markdown("""
        <div class="fade-in-up">
            <h2 style="color: #667eea;">🔍 Extracted Keywords</h2>
        </div>
        """, unsafe_allow_html=True)
    ...
    with tab3:
        st.markdown("""
        <div class="fade-in-up">
            <h2 style="color: #667eea;">📊 Keywords Visualization</h2>
        </div>
        """, unsafe_allow_html=True)
    ...
    with tab4:
        st.markdown("""
        <div class="fade-in-up">
            <h2 style="color: #667eea;">📝 Original Text Preview</h2>
        </div>
        """, unsafe_allow_html=True)
    ...
    st.markdown("""
    <div class="fade-in-up">
        <h2 style="color: #667eea; text-align: center;">💾 Export Your Results</h2>
    </div>
    """, unsafe_allow_html=True)
...
"""
    ...
    <div class="fade-in-up">
        <div style="
            ...
            margin: 2rem 0;
        ">
            <h3 style="color: #667eea; margin-bottom: 1rem;">👆 Please process a document to see results</h3>
            <p style="color: #666;">Upload a file or paste text to get started with summarization</p>
        </div>
    </div>
    """, unsafe_allow_html=True)
